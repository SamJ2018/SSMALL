package com.ssmall.order.service.impl;

import java.math.BigDecimal;
import java.util.Date;
import java.util.List;

import com.ssmall.mapper.TbOrderItemMapper;
...
import com.ssmall.mapper.TbOrderMapper;
import com.ssmall.pojo.TbOrder;
import com.ssmall.pojo.TbOrderExample;
import com.ssmall.pojo.TbOrderExample.Criteria;
import com.ssmall.order.service.OrderService;
    ...
    public void add(TbOrder order) {
        ...
        for (Cart cart : cartList) {
            ...
            for (TbOrderItem orderItem : cart.getOrderItemList()) {
                orderItem.setId(idWorker.nextId());//后期需要分片，主键
