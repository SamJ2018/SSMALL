...
import com.ssmall.mapper.*;
import com.ssmall.pojo.*;
import com.ssmall.pojogroup.Goods;
import org.springframework.beans.factory.annotation.Autowired;
import com.alibaba.dubbo.config.annotation.Service;
import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import com.ssmall.pojo.TbGoodsExample.Criteria;
import com.ssmall.sellergoods.service.GoodsService;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    public PageResult findPage(TbGoods goods, int pageNum, int pageSize) {
        ...
        criteria.andIsDeleteIsNull();//查询isDelete为未逻辑删除的记录
    ...
    public List<TbItem> findItemListByGoodsIdListAndStatus(Long[] goodsIds,String status){
        ...
        criteria.andGoodsIdIn(Arrays.asList(goodsIds));//将数组转为集合，指定条件：SPUId集合
